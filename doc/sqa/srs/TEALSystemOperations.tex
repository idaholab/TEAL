...
%
% REPLACE THIS ITEM WITH THE ONE ABOVE ONCE THE TEAL GETS OPENSOURCE
%
%  \item  The TEAL plug-in in its entirety will be made available for licensees in the INL GITLAB system.
\end{itemize}
\subsubsection{Human System Integration Requirements}
...
% REPLACE THIS ITEM WITH THE ONE ABOVE ONCE THE TEAL GETS OPENSOURCE
%
%The TEAL plug-in in its entirety will be made available on an appropriate protected repository hosting site (i.e. INL GITLAB).
%Backups and security services will be provided by the hosting service.
