...
%  \item  The CashFlow plug-in in its entirety will be made publicly available under the Apache version 2.0 license.     
%
% REPLACE THIS ITEM WITH THE ONE ABOVE ONCE THE CASH FLOW GETS OPENSOURCE
%
...
%The CashFlow plug-in in its entirety will be made publicly available on an appropriate repository hosting site (e.g. GitHub).
